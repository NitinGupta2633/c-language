...
int main()
{
	...
	cout<<"no of elements in vector1 are=  "<<vector1.sizeof()<<endl;
	add=100;
	...
	cout<<"no of elements in vector2 are = "<<vector2.sizeof()<<endl;
	...
	cout<<"elments in first row of vector_2d are=="<<vector_2d.at(0).at(0)<<" , "<<vector_2d.at(0).at(1)<<endl;
	cout<<"elements in second row of vector_2d are=="<<vector_2d.at(1).at(0)<<" , "<<vector_2d.at(1).at(1)<<endl;
	cot<<"first element index 0 ="<<vector1.at(0)<<endl;
	cout<<"second element index 1="<<vector.at(1)<<endl;
	return 0;
}